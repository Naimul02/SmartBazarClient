...
const ProductDetails = () => {
    ...
    return (
        <div className=' bg-white '>
            ...
            <div className='max-w'>
                <div className=' grid grid-cols-12 gap-3 w-full bb py-5 '>
                    <div className='  col-span-5 h-20 bb'>

                    </div>
                    <div className=' col-span-7 text-black   flex flex-col text-sm  space-y-2'>
